...
export default new Router({
  routes: [{
    ...
    children: [
      ...
      {path: '/detail',component: r => require.ensure([], () => r(require('../page/goodsDetails/goodsDetails.vue')), 'detail')}, //详细信息
      ...
      {path: '/search',component: r => require.ensure([], () => r(require('../page/search/search.vue')), 'search')}, //搜索
      ...
      {path: '/collect',component: r => require.ensure([],() => r(require('../page/collect/collect.vue')), 'collect')}, //收藏
    ]
  }]
})