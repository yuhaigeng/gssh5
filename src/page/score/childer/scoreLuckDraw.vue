                    ...
                    <div class="score_active_main">
                        ...
                        <div class="score_active_center">
                            <div class="score_active_turntable">
                                <img class="pointer1" src="../../../assetc/img/img_Pointer@2x.png" alt="" />
                                ...
                                <img class="pointer" src="../../../assetc/img/btn_Start draw@2x.png" @click="btn_Start"/>
                            </div>
                        </div>
...
<style scoped>
.icon_ad2 {
	background: url(../../../assetc/img/icon_ad@3x.png) no-repeat 20px center;
}
.sprite_login {
	background-image: url(../../../assetc/img/sprite_login.png);
...
.score_active_center{height: 814px;background:url(../../../assetc/img/img_bg_money@2x.png) no-repeat center ;}
.score_active_turntable{width: 750px; height: 814px; background: url(../../../assetc/img/img_Lottery_turntable_a@2x.png) no-repeat center;position: relative;overflow: hidden;}
