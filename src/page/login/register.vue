        ...
        <div class="main-wrap login_main-wrap">
				<div class="main">
					<ul class="apply_service_main" :class="{'hidden':mainHidden}">
						...
						<li>
							<span class="left">选择地址：</span><input type="text" id="street" placeholder="点击选择详细地址"  readonly="readonly" @focus="focus" @blur="blur" @click="selStreet" @input = "streetValue"/>
					...
					<dl class="apply_suc" :class="mainHidden ? '' :'hidden'">
						...
						<dd>
							...
							<a :herf=" !mainHidden &&'tel:400-800-9696'" class="">立即呼叫</a>
						</dd>
					</dl>
				</div>
				<button class="submit_btn" :class="{'hidden':mainHidden}"  @click="submitBtn">提交申请</button>
			</div>
